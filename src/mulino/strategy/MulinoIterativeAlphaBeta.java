...
public class MulinoIterativeAlphaBeta extends Strategy implements AdversarialSearch<MulinoState, GameAction> {
	...
	public MulinoIterativeAlphaBeta(MulinoGame game, FunzioneEuristica heuristic, int nrIterations) {
		this.game = game;
...
//		System.out.println(state + " val = " + result);
	...
	public void chooseAction(GameState state) {
		GameAction bestAction = makeDecision((MulinoState)state);
