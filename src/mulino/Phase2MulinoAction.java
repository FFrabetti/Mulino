...
public class Phase2MulinoAction extends MulinoAction {

	private int[] from;
	private int[] to;

	public Phase2MulinoAction(int[] from, int[] to) {
		super();
		this.from[0] = from[0];
		this.from[1] = from[1];
		this.to[0] = to[0];
	...
	public Phase2MulinoAction(int[] from, int[] to, int[] enemyPosition) {
		super(enemyPosition);
		this.from[0] = from[0];
		this.from[1] = from[1];
		this.to[0] = to[0];
